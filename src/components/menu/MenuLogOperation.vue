	...
	<div class="data-config">
		<div class="main">
			<div class="data-config-header1">
				<span class="data-config-header1-left"><i class="el-icon-menu"></i> 操作日志</span>
			</div>
			<div class="data-config-header2">
				<el-form ref="form" :inline="true" size="small">
					<el-form-item label="姓名：">
					    <el-input placeholder="请输入全部或部分姓名" v-model="formSearch.username"></el-input>
					</el-form-item>
					<el-form-item label="登录账号：">
					    <el-input placeholder="请输入全部或部分登录账号" v-model="formSearch.account"></el-input>
					</el-form-item>
			...
			<div class="data-config-main">
				<el-table size="mini" border class="loadingTable" :data="tableData">
					...
					<el-table-column prop="opdate" label="操作时间" align="center"></el-table-column>
					<el-table-column prop="name" label="姓名" align="center"></el-table-column>
					<el-table-column prop="account" label="登录账号" align="center"></el-table-column>
					<el-table-column prop="ip" label="IP" align="center"></el-table-column>
					<el-table-column prop="funName" label="功能模块" align="center"></el-table-column>
					<el-table-column label="操作类型" align="center">
						<template slot-scope="scope">
							<span v-if="scope.row.state == 0" style="color: red;">删除</span>
							<span v-if="scope.row.state == 1" style="color: forestgreen;">新增</span>
							<span v-if="scope.row.state == 2" style="color: #3A8EE6;">修改</span>
					    </template>
					</el-table-column>
	...
	export default {
		...
		methods: {
			...
			getData(){
				...
				TK_URL.Method.http(TK_URL.Menu.Log.Operation.TableData, data, (res)=>{
